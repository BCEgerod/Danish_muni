...
\begin{landscape}
	...
	\begin{table}[!htbp] \centering 
		...
		\begin{tabular}{@{\extracolsep{5pt}}lcccccccc} 
			...
			\hline \\[-1.8ex] 
			&\multicolumn{8}{c}{\emph{Panel A: Municipal Election Results}} \\
			\begin{tabular}{l}
		Right-Wing Vote Share\\(Municipal Elections)
			\end{tabular} & 0.416$^{***}$ & 0.129$^{***}$ & 0.145$^{***}$ & 0.065$^{***}$  & 1.110$^{***}$ & 0.317$^{***}$ & 0.335$^{***}$ & 0.144$^{***}$ \\ 
			...
			\hline \\[-1.8ex]
			&\multicolumn{8}{c}{\emph{Panel B: National Election Results}} \\
			\begin{tabular}{l} 
			 Right-Wing Vote Share\\ (National Elections) 
			\end{tabular}& $-$0.353$^{***}$ & $-$0.979$^{***}$ & $-$1.272$^{***}$ & $-$0.649$^{***}$ & 0.200 & $-$1.811$^{***}$ & $-$2.586$^{***}$ &  $-$1.295$^{***}$\\ 
			& (0.128) & (0.139) & (0.222) & (0.110)  & (0.250) & (0.307) & (0.493) &  (0.247)\\ 
			Population Size (logged) & $-$0.158$^{***}$ & $-$0.334$^{*}$   & & $-$0.415$^{**}$ & $-$0.258$^{***}$ & $-$0.659 &  & $-$0.810$^{**}$ \\ 
			& (0.027) & (0.189) &   & (0.173) & (0.055) & (0.417) &  &  (0.385) \\ 
			Constant & 1.408$^{***}$ &  &  & 0.176$^{***}$ & 2.249$^{***}$ &  &  & 0.331$^{***}$ \\ 
			& (0.257) &  &  & (0.008) & (0.531) &  &  & (0.019) \\ 
			\hline \\[-1.8ex] 
			...
			\hline 
			\hline \\[-1.8ex] 
			\multicolumn{9}{p{25 cm}}{\emph{Note: Panel A and B use, respectively, municipal and national electoral support for right-wing parties to gauge the policy preferences of the municipal electorate. Estimates are unstandardized OLS coefficients. Beck-Katz standard errors in parentheses in first-difference models, Arellano-White standard errors with clustering on municipality level used in the remaining models to correct for temporal autocorrelation. $^{*}$, $^{**}$ and $^{***}$ indicate statistical significance at the 10, 5 and 1 percent levels, respectively. Differences in the coefficients between panels are driven by a larger standard deviation in the reduced measure. See Appendix \ref{item} for results using the individual policy indicators.}} \\
		\end{tabular} 
	\end{table}
